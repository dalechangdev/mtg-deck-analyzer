...
export function CardThumbnail({ card }: { card: CardData }) {
  ...
  return (
    ...
    >
      ...
      {hovered && (
        <div className="absolute z-50 left-full top-0 ml-2 w-56 rounded-lg border border-border bg-popover p-3 shadow-xl text-xs space-y-1 pointer-events-none">

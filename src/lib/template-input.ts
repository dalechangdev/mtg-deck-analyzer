...
export async function validateNewTemplate(
  ...
  const result = await validate(body, "create");
...
export async function validateTemplateUpdate(
  ...
  return validate(body, "update", templateId);
}
...
async function validate(
  ...
  if (input.name && (await nameIsTaken(input.name, templateId))) {
...
export async function nameIsTaken(name: string, excludeId?: string): Promise<boolean> {
